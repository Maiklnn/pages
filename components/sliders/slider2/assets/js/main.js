...
document.addEventListener('click', function (e) {
  var element = e.target; // бургеп

  var burger = element.closest('.header-burger');
  ...
  var hasChildren = element.parentElement;

  if (hasChildren.classList.contains('menu-item-has-children')) {
    e.preventDefault();
    var mobileBack = hasChildren.querySelector('.mobile-back');

    if (!mobileBack) {
      var ul = hasChildren.querySelector('ul');
...
var mySwiper = new Swiper(document.querySelector(".".concat(sliderProjectsClass)), {
  spaceBetween: 150,
  // растояние
  ...
  speed: 3000,
  navigation: {
    nextEl: ".".concat(sliderProjectsClass, "-navigation__button-next"),
    prevEl: ".".concat(sliderProjectsClass, "-navigation__button-prev")
  },
  pagination: {
    type: 'bullets',
    // type: 'fraction',
    el: ".".concat(sliderProjectsClass, "-pagination"),
    clickable: true
  },
  breakpoints: {
    200: {
